                ...
                >
                    {VALUES.map((val, index) => (
                        <motion.div
                            ...
                            className="sticky md:static bg-[#14274E]/80 backdrop-blur-md md:bg-white/5 md:backdrop-blur-md rounded-3xl p-8 border border-white/10 hover:border-white/20 md:hover:-translate-y-2 transition-all duration-300 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1),inset_0_-1px_10px_rgba(255,255,255,0.02)] md:shadow-xl md:shadow-black/20 group mb-6 md:mb-0 overflow-hidden"
                        >
                            {/* Inner liquid glow effect */}
