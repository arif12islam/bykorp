            ...
            >
                <div
                    className={cn(
                        ...
                        isScrolled
                            ? "max-w-5xl h-16 bg-white/30 backdrop-blur-[32px] saturate-150 border border-white/40 shadow-[rgba(0,0,0,0.05)_0_8px_32px_0] ring-1 ring-inset ring-white/60 rounded-full"
