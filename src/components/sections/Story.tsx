...
export function Story() {
    ...
    // --- DESKTOP SEAMLESS & FLUID ANIMATION ---
    // Elegant text scaling and gentle blur crossfade
    const dTextOp1 = useTransform(scrollYProgress, [0, 0.25, 0.33], [1, 1, 0])
    const dTextScale1 = useTransform(scrollYProgress, [0, 0.25, 0.33], [1, 1.02, 1.05])
    const dTextY1 = useTransform(scrollYProgress, [0, 0.25, 0.33], [0, 0, -30])

    const dTextOp2 = useTransform(scrollYProgress, [0.25, 0.4, 0.55, 0.66], [0, 1, 1, 0])
    const dTextScale2 = useTransform(scrollYProgress, [0.25, 0.4, 0.55, 0.66], [0.95, 1, 1.02, 1.05])
    const dTextY2 = useTransform(scrollYProgress, [0.25, 0.4, 0.55, 0.66], [30, 0, 0, -30])

    const dTextOp3 = useTransform(scrollYProgress, [0.6, 0.75, 1], [0, 1, 1])
    const dTextScale3 = useTransform(scrollYProgress, [0.6, 0.75, 1], [0.95, 1, 1])
    const dTextY3 = useTransform(scrollYProgress, [0.6, 0.75, 1], [30, 0, 0])
    ...
    // Seamless, slow elegant image crossfade (Ken Burns style drifting)
    const dImgOp1 = useTransform(scrollYProgress, [0, 0.25, 0.33], [1, 1, 0])
    const dImgY1 = useTransform(scrollYProgress, [0, 0.25, 0.33], [0, -15, -40])
    const dImgScale1 = useTransform(scrollYProgress, [0, 0.25, 0.33], [1, 1.02, 1.05])

    const dImgOp2 = useTransform(scrollYProgress, [0.25, 0.4, 0.55, 0.66], [0, 1, 1, 0])
    const dImgY2 = useTransform(scrollYProgress, [0.25, 0.4, 0.55, 0.66], [40, 0, -15, -40])
    const dImgScale2 = useTransform(scrollYProgress, [0.25, 0.4, 0.55, 0.66], [0.95, 1, 1.02, 1.05])

    const dImgOp3 = useTransform(scrollYProgress, [0.6, 0.75, 1], [0, 1, 1])
    const dImgY3 = useTransform(scrollYProgress, [0.6, 0.75, 1], [40, 0, -15])
    const dImgScale3 = useTransform(scrollYProgress, [0.6, 0.75, 1], [0.95, 1, 1.02])

    const deskImgOps = [dImgOp1, dImgOp2, dImgOp3]
    const deskImgYs = [dImgY1, dImgY2, dImgY3]
